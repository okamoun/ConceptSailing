...
export default function ProposalClient({ token }: Props) {
  ...
  useEffect(() => {
    getProposalByToken(token)
      .then(async p => {
        ...
        setProposal(p);
        // Mark as viewed on first client visit
        if (p.status === 'sent') {
          await markProposalViewed(p.id);
  ...
  async function handleComment(e: React.FormEvent) {
    e.preventDefault();
    if (!proposal || !commentName.trim() || !commentText.trim()) return;
    ...
    try {
      ...
      setProposal(prev =>
        prev
          ? { ...prev, status: 'commented', comments: [...prev.comments, newComment] }
          : prev
      );
      setCommentText('');
      setCommentSent(true);
  ...
  if (notFound || !proposal) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 px-4">
        ...
        <a href={`mailto:${CONTACT.email}`} className="text-blue-600 underline text-sm">
          {CONTACT.email}
        </a>
      </div>
    );
  ...
  const nights = nightCount(proposal.startDate, proposal.endDate);
    ...
    <>
      ...
      <style>{`
        @media print {
          ...
          .print-white { background: white !important; box-shadow: none !important; }
          nav, footer { display: none !important; }
        }
      `}</style>

      <div className="min-h-screen bg-gray-50 py-8 px-4 print-white">
        <div className="max-w-4xl mx-auto">

          {/* Header */}
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6 print-white">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
              ...
              <div className="text-right">
                <div className="text-2xl font-bold text-gray-900">{proposalRef(proposal.id)}</div>
                <div className="text-xs text-gray-500 mt-1">
                  Prepared: {proposal.createdAt
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="font-semibold text-gray-900">{proposal.clientName}</div>
                  <div className="text-sm text-gray-600">{proposal.clientEmail}</div>
                  {proposal.clientPhone && <div className="text-sm text-gray-500">{proposal.clientPhone}</div>}
                </div>
                <div>
          ...
          {proposal.status === 'approved' && (
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 mb-6 text-center no-print">
              ...
              <p className="text-emerald-700 text-sm mt-1">
                Thank you for approving this proposal. We will be in touch shortly to finalise your charter agreement.
              </p>
            </div>
          )}
          {proposal.status === 'rejected' && (
            <div className="bg-red-50 border border-red-200 rounded-2xl p-5 mb-6 text-center no-print">
              ...
              <p className="text-red-700 text-sm mt-1">
                You have declined this proposal. Please contact us to discuss alternatives or adjustments.
              </p>
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6 print-white">
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4">
              <div>
                ...
                <div className="font-semibold text-gray-900">{proposal.boatName}</div>
              </div>
              <div>
                <div className="text-xs text-gray-400 mb-0.5">Guests</div>
                <div className="font-semibold text-gray-900">{proposal.passengers} passengers</div>
              </div>
              <div>
                <div className="text-xs text-gray-400 mb-0.5">Charter Period</div>
                <div className="font-semibold text-gray-900">
                  {fmtDate(proposal.startDate)} → {fmtDate(proposal.endDate)}
                </div>
              ...
              <div>
                ...
                <div className="font-semibold text-gray-900">{proposal.embarkationPort}</div>
                {proposal.disembarkationPort !== proposal.embarkationPort && (
                  <div className="text-sm text-gray-500">↩ {proposal.disembarkationPort}</div>
                )}
              </div>
              {proposal.selectedTheme && (
                <div>
                  <div className="text-xs text-gray-400 mb-0.5">Experience Theme</div>
                  <div className="font-semibold text-gray-900">{proposal.selectedTheme}</div>
                </div>
              )}
            </div>
            ...
            {proposal.itinerarySummary && (
              <div className="mt-6 pt-6 border-t border-gray-100">
                ...
                <p className="text-gray-700 text-sm leading-relaxed whitespace-pre-wrap">{proposal.itinerarySummary}</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6 print-white">
            ...
            <div className="space-y-3">
              ...
              {totals.apa > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">
                    APA — Additional Provisioning Allowance ({proposal.pricing.apaPercentage}%)
                  </span>
              ...
              <div className="flex justify-between font-bold text-base border-t-2 border-gray-200 pt-3 mt-1">
            ...
            {totals.apa > 0 && (
              <p className="mt-4 text-xs text-gray-400 leading-relaxed">
                The APA (Additional Provisioning Allowance) is an advance held by the captain to cover
                fuel, port and marina fees, provisions, crew gratuities, and other running expenses during
                the charter. Any unspent balance is returned at the end of the charter.
              </p>
            )}
          </div>
                ...
                <div className="flex gap-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Due 14 days prior to charter. Fully refundable within 14 days of charter completion, subject to the vessel inspection report.
                    </p>
                  </div>
                </div>
              )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-6 print-white">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800 leading-relaxed">
                  This proposal is issued subject to the standard{' '}
                  <strong>MYBA (Mediterranean Yacht Brokers Association) Charter Agreement</strong>.
                  Upon acceptance, the legally binding charter contract will be issued incorporating
                  the MYBA terms and conditions in their entirety, together with any special conditions
                  set out below. The MYBA Charter Agreement governs all aspects of the charter, including
                  cancellation policy, liability, and dispute resolution.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Comments & Approval — hidden in print */}
            ...
            {proposal.status !== 'draft' && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6">
                <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">
                  {proposal.comments.length > 0 ? 'Add a Comment' : 'Questions or Comments?'}
                </h2>
                {commentSent ? (
                  <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-center">
                    <div className="text-emerald-700 font-medium text-sm">Message sent — thank you!</div>
                    <div className="text-emerald-600 text-xs mt-1">We will get back to you shortly.</div>
                    <button
                  ...
                  <form onSubmit={handleComment} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        placeholder="Ask a question or leave feedback about this proposal…"
            ...
            {canAct && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Once you are happy with the proposal, you can approve it below. Upon approval we will
                  issue the formal MYBA Charter Agreement for signature.
                </p>
                ...
                {confirmAction === null ? (
                  ...
                  <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5">
                    <p className="text-emerald-800 font-medium text-sm mb-4">
                      Please confirm you wish to approve this proposal. We will then proceed to issue the
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 text-gray-600 text-sm hover:text-gray-800"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-xl p-5">
                    <p className="text-red-800 font-medium text-sm mb-4">
                      Are you sure you wish to decline this proposal? You can add a comment above
                      to let us know how we can adjust it to better suit your requirements.
                    </p>
                    <div className="flex gap-3">
                      <button
          ...
          {/* Footer */}
          <div className="text-center text-xs text-gray-400 pb-8 print-white">
