...
export const metadata: Metadata = {
  ...
  description: 'Discover our fleet of luxury, eco-friendly catamarans (48-60ft). Explore features, specs, and images of our exclusive yachts.'
};
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#101824] to-[#1f2937] py-16">
      <div className="max-w-6xl mx-auto px-4">
        <h1 className="text-6xl font-black text-accent drop-shadow-lg mb-10 text-center animate-fade-in-up">Our Luxury Eco Catamarans</h1>
        <p className="text-2xl text-gray-200 mb-12 text-center animate-fade-in-up" style={{animationDelay:'0.12s',animationFillMode:'both'}}>Sail aboard the finest eco-friendly catamarans (48-60ft) from Fountaine Pajot and Lagoon. Each yacht is equipped with advanced safety systems, solar panels, watermakers, and a full range of leisure gear for your comfort and enjoyment.</p>
