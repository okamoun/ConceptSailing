          ...
          <div className="mt-10 pt-8 border-t border-blue-200">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <a href="mailto:contact@nj3cruises.com" className="text-blue-600 font-semibold hover:text-blue-800 transition-colors">
              ...
              <div>
                ...
                <a href={`tel:${CONTACT.phone.href}`} className="text-blue-600 font-semibold hover:text-blue-800 transition-colors">
